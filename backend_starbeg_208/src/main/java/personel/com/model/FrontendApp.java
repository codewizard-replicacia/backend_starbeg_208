...
@Table(name = "\"FrontendApp\"", schema =  "\"db\"")
@Data
...
@Column(name = "\"MetaTags\"")
    ...
    @CollectionTable(schema = "\"db\"", name = "\"FrontendAppMetaTags\"",joinColumns = @JoinColumn(name = "\"AppId\""))
...
@Column(name = "\"SelectedScreenIds\"")
    @ElementCollection(fetch = FetchType.LAZY)
    @CollectionTable(schema = "\"db\"", name = "\"FrontendAppSelectedScreenIds\"",joinColumns = @JoinColumn(name = "\"AppId\""))
...
@JoinTable(
            ...
            inverseJoinColumns = @JoinColumn( name="\"FeScreenId\""), schema = "\"db\"")
